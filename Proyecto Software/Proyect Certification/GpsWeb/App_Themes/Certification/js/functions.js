			...
			'<div class="modal-dialog modal-lg">' +
				...
				'<div class="modal-body">' +
					...
					'<a data-skin="skin-blur-violate" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="App_Themes/Certification/img/body/violate.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-night" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="App_Themes/Certification/img/body/night.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-ocean" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="App_Themes/Certification/img/body/ocean.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-sunset" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="App_Themes/Certification/img/body/sunset.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-yellow" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="App_Themes/Certification/img/body/yellow.jpg" alt="">' +
					'</a>' +
					'<a  data-skin="skin-blur-nexus"class="col-sm-2 col-xs-4" href="">' +
					    '<img src="App_Themes/Certification/img/body/nexus.jpg" alt="">' +
					'</a>' +
				    '</div>' +
				'</div>' +
			    '</div>' +
